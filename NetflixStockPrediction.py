...
def load_data(file_path):
    ...
    df['Open'] = pd.to_numeric(df['Open'].astype(str).str.replace(',', ''))
    df['High'] = pd.to_numeric(df['High'].astype(str).str.replace(',', ''))
    df['Low'] = pd.to_numeric(df['Low'].astype(str).str.replace(',', ''))
    df['Close'] = pd.to_numeric(df['Close'].astype(str).str.replace(',', ''))
    df['Adj Close'] = pd.to_numeric(df['Adj Close'].astype(str).str.replace(',', ''))
    df['Volume'] = pd.to_numeric(df['Volume'].astype(str).str.replace(',', ''))
